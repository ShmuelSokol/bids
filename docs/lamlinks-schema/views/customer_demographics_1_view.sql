-- dbo.customer_demographics_1_view



/* view customer_demographics_1_view: add view */
...
/* view customer_demographics_1_view: add view 
 ...
 view customer_demographics_1_view: add view 
 view customer_demographics_1_view: add view */
CREATE VIEW [dbo].[customer_demographics_1_view]
AS
SELECT        dbo.k31_tab.idnk31_k31, dbo.k31_tab.uptime_k31, dbo.k31_tab.upname_k31, dbo.k31_tab.idnk12_k31, dbo.k31_tab.a_code_k31, dbo.k31_tab.c_code_k31, dbo.k31_tab.c_name_k31, 
                         ...
                         dbo.demographics_1_view.d_phon_ka7, dbo.demographics_1_view.d_faxn_ka7, dbo.demographics_1_view.d_emal_ka7, dbo.demographics_1_view.d_cell_ka7, dbo.demographics_1_view.homurl_k12, 
                         dbo.demographics_1_view.e_desc_k12
FROM            dbo.k31_tab INNER JOIN
                         dbo.demographics_1_view ON dbo.k31_tab.idnk12_k31 = dbo.demographics_1_view.idnk12_k12
