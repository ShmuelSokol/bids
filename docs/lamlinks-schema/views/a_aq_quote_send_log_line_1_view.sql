-- dbo.a_aq_quote_send_log_line_1_view



/* view a_aq_quote_send_log_line_1_view: add view */
...
/* view a_aq_quote_send_log_line_1_view: add view */
CREATE VIEW [dbo].[a_aq_quote_send_log_line_1_view]
AS
SELECT        dbo.aq_quote_send_log_1_view.sol_no_k10, dbo.aq_quote_send_log_1_view.fsc_k08, dbo.aq_quote_send_log_1_view.niin_k08, dbo.aq_quote_send_log_1_view.q_time_kd8, 
                         ...
                         dbo.aq_quote_send_log_1_view.q_mode_kdh, dbo.kd8_tab.qclxml_kd8
FROM            dbo.kd8_tab RIGHT OUTER JOIN
                         dbo.aq_quote_send_log_1_view ON dbo.kd8_tab.idnkd8_kd8 = dbo.aq_quote_send_log_1_view.idnkd8_kd8 LEFT OUTER JOIN
