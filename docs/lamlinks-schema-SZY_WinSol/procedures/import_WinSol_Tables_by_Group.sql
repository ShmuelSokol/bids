-- dbo.import_WinSol_Tables_by_Group
...
CREATE procedure [dbo].[import_WinSol_Tables_by_Group]
...
begin
	...
	select 'inidp', 'r', 1, 
		...
		'constraint pkc_r_inidp_invoice_line primary key clustered (invoice, line)', 0, 'where NOT (INVOICE=''E467236'' or INVOICE=''E476016'' or INVOICE=''E488351'') ', null union all
	select 'inid_3', 'r', 1, 
