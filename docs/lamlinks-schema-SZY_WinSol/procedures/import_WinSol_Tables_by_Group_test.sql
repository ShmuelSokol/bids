-- dbo.import_WinSol_Tables_by_Group_test
...
create	procedure [dbo].[import_WinSol_Tables_by_Group_test]
...
begin
	...
	select 'popi', 'r', 1, 'prodct | char(20), SUPPLR | char(6), suppro, suppro2, purpri, per', 
