/** Create the dibbs_sol_clins table.
 *   npx tsx scripts/apply-dibbs-sol-clins.ts
 */
import "./env";
...
async function main() {
  ...
  const sql = readFileSync(join(__dirname, "sql", "dibbs-sol-clins.sql"), "utf-8");
