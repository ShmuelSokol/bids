/**
 * Create ll_shipments_by_kaj table.
 *   npx tsx scripts/apply-ll-shipments-by-kaj.ts
 */
import "./env";
...
async function main() {
  ...
  const sql = readFileSync(join(__dirname, "sql", "ll-shipments-by-kaj-schema.sql"), "utf-8");
