/**
 * Create the ll_pipeline_snapshots table for /ops/dibs-pipeline.
 *   npx tsx scripts/apply-ll-pipeline-snapshots.ts
 */
import "./env";
...
async function main() {
  ...
  const sql = readFileSync(join(__dirname, "sql", "ll-pipeline-snapshots.sql"), "utf-8");
