/**
 * Create all research pipeline tables.
 *   npx tsx scripts/apply-research-schema.ts
 */
import "./env";
...
async function main() {
  ...
  const sql = readFileSync(join(__dirname, "sql", "research-schema.sql"), "utf-8");
