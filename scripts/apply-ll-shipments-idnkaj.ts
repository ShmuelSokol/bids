/**
 * One-shot: add idnkaj column to ll_shipments + recreate view.
 *   npx tsx scripts/apply-ll-shipments-idnkaj.ts
 */
import "./env";
...
async function main() {
  ...
  const sql = readFileSync(join(__dirname, "sql", "ll-shipments-alter-idnkaj.sql"), "utf-8");
