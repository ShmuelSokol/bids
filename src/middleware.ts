...
const PUBLIC_PATHS = ["/login", "/api/auth", "/api/dibbs", "/api/track", "/api/bug-report", "/api/errors", "/api/notifications", "/api/jobs", "/api/bugs/respond", "/api/awards", "/api/setup-github-secrets", "/api/whatsapp", "/api/webhooks", "/api/orders/poll-ax"];
